...
a super simple React/Mobx app demonstrating pulling post data from a REST api
...
open a new window and run this command (to start the posts api server);

```
npm run posts
```

in another window run the following (to start the app);
